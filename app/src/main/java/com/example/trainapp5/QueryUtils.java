...
public final class QueryUtils {
    ...
    */
    ...
    private static List<Detail> extractFeatureFromJson(String earthquakeJSON) {
        ...
        List<Detail> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Detail earthquake = new Detail(magnitude, location, time, url);
    ...
    public static List<Detail> fetchEarthquakeData(String requestUrl) {
        ...
        List<Detail> earthquakes = extractFeatureFromJson(jsonResponse);
